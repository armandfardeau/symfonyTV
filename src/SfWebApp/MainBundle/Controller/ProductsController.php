...
class ProductsController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $products = $em->getRepository('SfWebAppMainBundle:Products')->findAll();

        return $this->render('@SfWebAppMain/products/index.html.twig', array(
            'products' => $products,
        ));
    }
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('SfWebApp\MainBundle\Form\ProductsType', $product);
        ...
        return $this->render('@SfWebAppMain/products/new.html.twig', array(
            'product' => $product,
    ...
    public function showAction(Products $product)
    {
        ...
        return $this->render('@SfWebAppMain/products/show.html.twig', array(
            'product' => $product,
    ...
    {
        $deleteForm = $this->createDeleteForm($product);
        $editForm = $this->createForm('SfWebApp\MainBundle\Form\ProductsType', $product);
        ...
        return $this->render('@SfWebAppMain/products/edit.html.twig', array(
            'product' => $product,
